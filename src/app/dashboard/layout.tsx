...
const navItems = [
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 [...]
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 [...]
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 1[...]
      </svg>
    ),
  },
  {
  ...
  {
    name: 'Locator',
    href: '/dashboard/patient/locator',
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link href={isDoctorRoute ? "/dashboard/doctor" : "/dashboard/patient"} className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-2xl bg-[#2ab8d8] flex items-center justify-center shadow-md shadow-[#2ab8d8]/30">
                <svg className="h-4.5 w-4.5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 21.593c-5.63-5.539-11-10.297-11-14.402 0-3.791 3.068-5.191 5.281-5.191 1.312 0 4.151.501 5.719 4.457 1.59-3.968 4.464-4.447 5.726-4.447 2.54 0 5.274 1.621 5.274 5.18[...]
                </svg>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-semibold text-gray-500 hover:text-[#003893] bg-gray-100/80 hover:bg-gray-200/80 rounded-xl transition border border-gray-200/60 backdrop-blur-s[...]
              >
                Sign out
              </button>
            </div>
